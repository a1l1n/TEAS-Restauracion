...
import whatPics from "../../../assets/Sliders/What/What.js";
import { AiOutlineLeft, AiOutlineRight } from "react-icons/ai";
import Styles from "./Slider.module.css";

export const WhatSlider = () => {
    const [selectedIndex, setSelectedIndex] = useState(0);
    const [selectedImage, setSelectedImage] = useState(whatPics[0]);
    ...
    const prev = () => {
        ...
        setTimeout(() => {
            ...
            const nextIndex = condition ? selectedIndex - 1 : whatPics.length - 1;
    ...
    const next = () => {
        setLoaded(false);
        setTimeout(() => {
            const condition = selectedIndex < whatPics.length - 1;
